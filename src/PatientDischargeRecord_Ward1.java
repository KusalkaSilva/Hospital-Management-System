...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 1230, 210));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sky-blue-color-wallpaper-4.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1230, 590));
